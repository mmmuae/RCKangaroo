...
#define LAUNCH_BOUNDS_MINBLOCKS_OLD_GPU	1
#define LAUNCH_BOUNDS_MINBLOCKS_NEW_GPU	2
#define LAUNCH_BOUNDS_MINBLOCKS_BLACKWELL	2
...
#define LAUNCH_BOUNDS_MINBLOCKS	LAUNCH_BOUNDS_MINBLOCKS_OLD_GPU
#elif __CUDA_ARCH__ >= 1200
#define BLOCK_SIZE			BLOCK_SIZE_BLACKWELL
#define PNT_GROUP_CNT		PNT_GROUP_BLACKWELL
#define LAUNCH_BOUNDS_MINBLOCKS	LAUNCH_BOUNDS_MINBLOCKS_BLACKWELL
#else
#define BLOCK_SIZE			BLOCK_SIZE_NEW_GPU	
#define PNT_GROUP_CNT		PNT_GROUP_NEW_GPU
#define LAUNCH_BOUNDS_MINBLOCKS	LAUNCH_BOUNDS_MINBLOCKS_NEW_GPU
#endif
